...
namespace SolarSystemApp
{
    ...
    public static class ProbeModelCatalog
    {
        ...
        static readonly Entry[] DisplayOrder =
        {
            ...
            new Entry { Kind = ProbeModelKind.Venera7, LocalizationKey = "ProbeModelVenera7", DescriptionKey = "ProbeDescVenera7", PortraitResourcePath = "ProbePortraits/Venera7", OriginKey = "ProbeOriginRussia", ShowInPicker = true },
