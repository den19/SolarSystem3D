...
/// <summary>
/// Moves an asteroid on a circular or inclined elliptical heliocentric orbit.
/// </summary>
public class AsteroidOrbitController : MonoBehaviour
{
    AsteroidCatalog.AsteroidDefinition _definition;
    Transform _sun;
    float _angle;
    ...
    public AsteroidCatalog.AsteroidDefinition Definition => _definition;
    ...
    public void Initialize(AsteroidCatalog.AsteroidDefinition definition, Transform sun, bool useRealOrbits)
    {
    ...
    void Update()
    {
        ...
        _angle += (Mathf.PI * 2f / Mathf.Max(0.01f, _definition.simPeriodSec)) * Time.deltaTime;
        UpdatePosition();
    }
